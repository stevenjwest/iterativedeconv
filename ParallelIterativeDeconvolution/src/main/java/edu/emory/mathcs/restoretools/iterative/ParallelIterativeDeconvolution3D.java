 ...
 * 
 */
public class ParallelIterativeDeconvolution3D implements PlugIn, ImageListener {
    ...
    public static String deconvolveMRNSD(String pathToBlurredImage, String pathToPsf, String pathToDeblurredImage, String preconditionerStr, String preconditionerTolStr, String boundaryStr, String resizingStr, String outputStr, String precisionStr, String stoppingTolStr, String thresholdStr,
        ...
        switch (precision) {
        case DOUBLE:
            MRNSDDoubleIterativeDeconvolver3D dmrnsd = new MRNSDDoubleIterativeDeconvolver3D(imB, imPSF, preconditioner, preconditionerTol, boundary, resizing, output, maxIters, showIterations, options);
            imX = dmrnsd.deconvolve();
            break;
        case SINGLE:
            MRNSDFloatIterativeDeconvolver3D fmrnsd = new MRNSDFloatIterativeDeconvolver3D(imB, imPSF, preconditioner, (float) preconditionerTol, boundary, resizing, output, maxIters, showIterations, options);
    ...
    public static String deconvolveHyBR(String pathToBlurredImage, String pathToPsf, String pathToDeblurredImage, String preconditionerStr, String preconditionerTolStr, String boundaryStr, String resizingStr, String outputStr, String precisionStr, String thresholdStr, String logConvergenceStr,
        ...
        switch (precision) {
        case DOUBLE:
            HyBRDoubleIterativeDeconvolver3D dhybr = new HyBRDoubleIterativeDeconvolver3D(imB, imPSF, preconditioner, preconditionerTol, boundary, resizing, output, maxIters, showIteration, options);
            imX = dhybr.deconvolve();
            break;
        case SINGLE:
            HyBRFloatIterativeDeconvolver3D fhybr = new HyBRFloatIterativeDeconvolver3D(imB, imPSF, preconditioner, (float) preconditionerTol, boundary, resizing, output, maxIters, showIteration, options);
    ...
    public static String deconvolveCGLS(String pathToBlurredImage, String pathToPsf, String pathToDeblurredImage, String preconditionerStr, String preconditionerTolStr, String boundaryStr, String resizingStr, String outputStr, String precisionStr, String stoppingTolStr, String thresholdStr,
        ...
        switch (precision) {
        case DOUBLE:
            CGLSDoubleIterativeDeconvolver3D dcgls = new CGLSDoubleIterativeDeconvolver3D(imB, imPSF, preconditioner, preconditionerTol, boundary, resizing, output, maxIters, showIterations, options);
            imX = dcgls.deconvolve();
            break;
        case SINGLE:
            CGLSFloatIterativeDeconvolver3D fcgls = new CGLSFloatIterativeDeconvolver3D(imB, imPSF, preconditioner, (float) preconditionerTol, boundary, resizing, output, maxIters, showIterations, options);
    ...
    public void run(String arg) {
        ...
        mainPanel = new MainPanel("Parallel Iterative Deconvolution 3D " + version + " ");
    }
    ...
    private class WPLOptionsPanel extends JFrame {
        ...
        private class FilterZFieldActionListener implements ActionListener {
            public void actionPerformed(ActionEvent e) {
                ...
                if (filterZ < 0.0) {
                    IJ.error("Filter x must be a nonnegative value.");
                }
            }
        }
                ...
                Thread deconvolveThread = new Thread(new Runnable() {
                    public void run() {
                        ...
                        case DOUBLE:
                            switch (selMethod) {
                            case CGLS:
                                dcgls = new CGLSDoubleIterativeDeconvolver3D(imB, imPSF, selPrecond, precTol, selBoundary, selResizing, selOutput, maxIters, itersCheck.isSelected(), cglsOptions);
                                imX = dcgls.deconvolve();
                                ...
                                break;
                            case MRNSD:
                                dmrnsd = new MRNSDDoubleIterativeDeconvolver3D(imB, imPSF, selPrecond, precTol, selBoundary, selResizing, selOutput, maxIters, itersCheck.isSelected(), mrnsdOptions);
                                imX = dmrnsd.deconvolve();
                                if (selPrecond != PreconditionerType.NONE) {
                                ...
                                break;
                            case HyBR:
                                dhybr = new HyBRDoubleIterativeDeconvolver3D(imB, imPSF, selPrecond, precTol, selBoundary, selResizing, selOutput, maxIters, itersCheck.isSelected(), hybrOptions);
                                imX = dhybr.deconvolve();
                                if (selPrecond != PreconditionerType.NONE) {
                                ...
                                break;
                            case WPL:
                                dwpl = new WPLDoubleIterativeDeconvolver3D(imB, imPSF[0][0][0], selBoundary, selResizing, selOutput, maxIters, itersCheck.isSelected(), wplOptions);
                                imX = dwpl.deconvolve();
                                dwpl = null;
                                timer.stop();
                                break;
                        ...
                        case SINGLE:
                            switch (selMethod) {
                            case CGLS:
                                fcgls = new CGLSFloatIterativeDeconvolver3D(imB, imPSF, selPrecond, (float) precTol, selBoundary, selResizing, selOutput, maxIters, itersCheck.isSelected(), cglsOptions);
                                imX = fcgls.deconvolve();
                                if (selPrecond != PreconditionerType.NONE) {
                                ...
                                break;
                            case MRNSD:
                                fmrnsd = new MRNSDFloatIterativeDeconvolver3D(imB, imPSF, selPrecond, (float) precTol, selBoundary, selResizing, selOutput, maxIters, itersCheck.isSelected(), mrnsdOptions);
                                imX = fmrnsd.deconvolve();
                                if (selPrecond != PreconditionerType.NONE) {
                                ...
                                break;
                            case HyBR:
                                fhybr = new HyBRFloatIterativeDeconvolver3D(imB, imPSF, selPrecond, (float) precTol, selBoundary, selResizing, selOutput, maxIters, itersCheck.isSelected(), hybrOptions);
                                imX = fhybr.deconvolve();
                                if (selPrecond != PreconditionerType.NONE) {
                                ...
                                break;
                            case WPL:
                                fwpl = new WPLFloatIterativeDeconvolver3D(imB, imPSF[0][0][0], selBoundary, selResizing, selOutput, maxIters, itersCheck.isSelected(), wplOptions);
                                imX = fwpl.deconvolve();
                                fwpl = null;
                                timer.stop();
                                break;
    ...
    public static void main(String args[]) {
        ...
        IJ.runPlugIn("edu.emory.mathcs.restoretools.iterative.ParallelIterativeDeconvolution3D", null);
    }
